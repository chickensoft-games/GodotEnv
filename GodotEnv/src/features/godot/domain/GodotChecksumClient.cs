...
public interface IGodotChecksumClient
{
  ...
  Task VerifyArchiveChecksum(GodotCompressedArchive archive, string? proxyUrl = null);
  ...
  Task<string> GetExpectedChecksumForArchive(GodotCompressedArchive archive, string? proxyUrl = null);
  /// <summary>
  ...
  /// <returns>Checksum as hex-string</returns>
  Task<string> ComputeChecksumOfArchive(GodotCompressedArchive archive);
}
